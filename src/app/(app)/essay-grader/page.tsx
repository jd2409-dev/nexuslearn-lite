...
import { Loader2, FileText, Wand2, Sparkles, CheckCircle, BarChart3, BrainCircuit, ShieldAlert, ShieldCheck } from "lucide-react";
        ...
        <CardContent>
          ...
          {!isLoading && results && (
            <div className="space-y-6">
                ...
                <Alert variant={results.aiGenerated ? "destructive" : "default"} className={results.aiGenerated ? "" : "border-green-500/50 text-green-700 dark:text-green-400"}>
                  {results.aiGenerated ? <ShieldAlert className="h-4 w-4" /> : <ShieldCheck className="h-4 w-4" />}
                  <AlertTitle>{results.aiGenerated ? "AI Generated Content Detected" : "Likely Human-Written"}</AlertTitle>
                  <AlertDescription>
                    {results.aiGenerated 
                      ? "This essay shows strong signs of being generated by an AI. The originality score is low." 
                      : "This essay appears to be written by a human. The originality score is high."}
                  </AlertDescription>
                </Alert>
