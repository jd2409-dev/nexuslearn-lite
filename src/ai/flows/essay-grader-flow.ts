 ...
 * improvement, detailed feedback, a revised version of the essay, and an
 * analysis of whether the essay was likely AI-generated.
 *
...
const GradeEssayOutputSchema = z.object({
  ...
  aiDetection: z.object({
    isLikelyAiGenerated: z.boolean().describe("A boolean indicating if the essay is likely AI-generated."),
    explanation: z.string().describe("A brief explanation for the AI detection conclusion, noting patterns like overly formal tone, complex vocabulary, or lack of personal voice."),
  }).describe("An analysis of whether the essay was likely generated by an AI."),
});
...
const essayGraderPrompt = ai.definePrompt({
  ...
  prompt: `
    ...
    5.  **AI-Generated Content Check**: Analyze the writing style, tone, and structure to determine if it's likely AI-generated. Provide a boolean and a short explanation for your conclusion.
